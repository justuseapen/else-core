<<<<<<< HEAD:src/agents/pi-embedded-runner/prompt-cache-observability.test.ts
=======
// Coverage for prompt-cache diagnostic tracking across turns.
>>>>>>> upstream/main:src/agents/embedded-agent-runner/prompt-cache-observability.test.ts
