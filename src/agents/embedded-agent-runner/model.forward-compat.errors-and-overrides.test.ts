...
<<<<<<< HEAD:src/agents/pi-embedded-runner/model.forward-compat.errors-and-overrides.test.ts
...
>>>>>>> upstream/main:src/agents/embedded-agent-runner/model.forward-compat.errors-and-overrides.test.ts
