<<<<<<< HEAD:src/agents/pi-embedded-runner/run/attempt.stop-reason-recovery.test.ts
...
>>>>>>> upstream/main:src/agents/embedded-agent-runner/run/attempt.stop-reason-recovery.test.ts
