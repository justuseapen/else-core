...
<<<<<<< HEAD:src/agents/pi-embedded-runner.sanitize-session-history.test-harness.ts
...
>>>>>>> upstream/main:src/agents/embedded-agent-runner.sanitize-session-history.test-harness.ts
