<<<<<<< HEAD:src/agents/pi-embedded-runner.sanitize-session-history.policy.test.ts
=======
// Smoke coverage for session-history sanitization policy wiring.
>>>>>>> upstream/main:src/agents/embedded-agent-runner.sanitize-session-history.policy.test.ts
