...
<<<<<<< HEAD:src/agents/pi-embedded-runner/run.overflow-compaction.e2e.test.ts
    },
...
>>>>>>> upstream/main:src/agents/pi-embedded-runner/run.overflow-compaction.loop.test.ts
