...
<<<<<<< HEAD:extensions/whatsapp/src/monitor-inbox.captures-media-path-image-messages.test.ts
...
>>>>>>> upstream/main:extensions/whatsapp/src/monitor-inbox.captures-media-path-image-messages.test-support.ts
  );
  return {
    ...actual,
    getChildLogger: () => ({
