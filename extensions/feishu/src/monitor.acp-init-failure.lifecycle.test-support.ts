...
<<<<<<< HEAD:extensions/feishu/src/monitor.acp-init-failure.lifecycle.test.ts
...
>>>>>>> upstream/main:extensions/feishu/src/monitor.acp-init-failure.lifecycle.test-support.ts
import {
